...
/// -- Physical push
    ...
    if (physicalobj != noone)
    {

        //ep_body_set_velocity_center(global.world, physicalobj.body, xSpeed, 0, 1)
...
/// -- Draw
    ...
    draw_sprite_ext(animSprite, animFrame, x, y, xDir, image_yscale, 0, image_blend, image_alpha);
